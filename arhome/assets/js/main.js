/*-----------------------------------------------------------------------------------
    Template Name: Arhome - Property and Apartment Template
    Template URI: site.com
    Description: Arhome - Property and Apartment Template
    Author: ThemexHunt
    Author URI: https://themexhunt.coom/
    Version: 1.0
...
(function($) {
    ...
    var sliderArrows = $('.apartment-arrows');
    $('.apartment-slider-one').slick({
		dots: false,
		arrows: true,
        infinite: true,
		autoplaySpeed: 1500,
